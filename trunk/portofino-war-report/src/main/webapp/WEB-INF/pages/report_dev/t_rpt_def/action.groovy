...
class CrudPage extends CrudAction4ReportDef {
    ...
    protected void createSetup(Object object) {
		...
		object.c_is_enabled= true;
        object.c_is_regular= true;
        object.c_is_query= true;
        object.c_display_type_id="grid";
        object.c_is_show_page_number= true;
        object.c_row_number_type= "all";
        object.c_chart_orientation= "Vertical";//Horizontal'
